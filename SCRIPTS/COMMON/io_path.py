...
output_path_reading_detection_evaluation = output_common_dir + r'/API_reading_detection_eval'
output_path_gesture_detection_evaluation = output_common_dir + r'/API_gesture_detection_eval'
